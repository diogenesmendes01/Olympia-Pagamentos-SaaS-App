  ...
  return (
    ...
    >
      <div className="mb-3 flex items-start justify-between">
        ...
        >
          {positive ? (
            <TrendingUp className="h-3 w-3" style={{ color: SUCCESS }} />
          ) : (
            <TrendingDown className="h-3 w-3" style={{ color: DANGER }} />
          )}
          <span
            style={{
              fontSize: 11,
      ...
      >
        {typeof value === "number" && value > 100 ? fmt(value) : value}
        {suffix}
      </p>
      <p
        style={{
    ...
    <div className="space-y-5 p-5 lg:p-6">
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
        {[
          ...
          <button
            key={a.label}
            className="flex items-center gap-2.5 rounded-2xl bg-white px-3 py-3 transition-all hover:shadow-md"
            style={{ border: "1px solid #E2E8F0" }}
          >
            <div
      ...
      <div className="grid grid-cols-2 gap-4 lg:grid-cols-3 xl:grid-cols-6">
        <KPICard
          ...
          value={kpiData.recebidoMes}
          trend={kpiData.recebidoMesTrend}
        ...
        <KPICard
          title="A Receber (30d)"
          value={kpiData.aReceber30d}
          trend={kpiData.aReceber30dTrend}
        ...
        <KPICard
          title="A Pagar (30d)"
          value={kpiData.apagarProx30d}
          trend={kpiData.apagarProx30dTrend}
          trendLabel="próximas obrigações"
          icon={ArrowUpCircle}
          color={WARNING}
        />
        <KPICard
          title="Saldo em Conta"
          value={kpiData.saldoConta}
          trend={kpiData.saldoContaTrend}
          trendLabel="todas as contas"
          icon={Wallet}
          color="#6B4BAF"
        />
        <KPICard
          title="Inadimplência"
          value={kpiData.taxaInadimplencia}
          trend={kpiData.taxaInadimplenciaTrend}
        ...
        <KPICard
          title="DSO"
          value={`${kpiData.dso}d`}
          trend={kpiData.dsoTrend}
          trendLabel="dias para receber"
          icon={Activity}
          color="#0E7B85"
          suffix=""
        />
        ...
        >
          <div className="mb-4 flex items-center justify-between">
            ...
            <span
              ...
              style={{ background: DANGER, fontSize: 10, fontWeight: 700 }}
            >
              2 urgentes
            </span>
          </div>
              ...
              <div className="text-right">
                <p
                  style={{
                    ...
                    fontSize: 13.5,
                    fontWeight: 700,
                    color: tx.tipo === "recebido" ? SUCCESS : WARNING,
                  }}
                >
                  {tx.tipo === "recebido" ? "+" : ""}
                  {fmtFull(tx.valor)}
