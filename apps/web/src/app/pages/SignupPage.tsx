...
export function SignupPage() {
  ...
  async function onSubmit(values: SignupInput) {
    // Self-service signup virou lead capture: quem chega na /signup direto
    // não cria conta — vê mensagem "obrigado pelo interesse". Mantemos o
    // signup real só pro fluxo de convite (Branch 1 da InvitationPage), em
    // que o dono da empresa já validou o usuário.
    if (!invitationId) {
    ...
    try {
      ...
      const callbackURL = `/invitation/${invitationId}`;
        ...
        >
          {interestSubmitted ? (
            <div className="p-8 text-center">
              ...
              <Link
                to="/login"
                className="inline-block rounded-xl px-5 py-2.5"
                style={{
