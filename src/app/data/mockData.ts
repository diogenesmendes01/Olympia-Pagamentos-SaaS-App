...
export const alerts = [
  {
    ...
    description:
      "Total de R$ 12.400,00 em atraso — Clientes: Grupo Nexus, Tech Solutions, MK Distribuidora",
    time: "Agora",
  },
  {
    id: 2,
...
export const receivables: Receivable[] = [
  ...
  {
    id: "REC-1045",
    cliente: "MK Distribuidora Eireli",
    cnpj: "56.789.012/0001-43",
    descricao: "Manutenção Mensal - Abr/26",
    valor: 3800.0,
    vencimento: "2026-04-22",
    emissao: "2026-04-01",
    status: "vencido",
  ...
  },
  {
    ...
    descricao: "Fornecimento Equipamentos",
    valor: 41500.0,
  ...
  },
  {
    ...
    descricao: "Serviços Logística - Abr/26",
    valor: 12400.0,
  ...
  {
    id: "REC-1049",
    cliente: "StartupBR Tecnologia",
    cnpj: "90.123.456/0001-87",
    descricao: "Mensalidade SaaS - Mai/26",
    valor: 2900.0,
  ...
  },
  {
    ...
    descricao: "Sistema de Gestão - Jun/26",
    valor: 1490.0,
  ...
  },
  {
    ...
    descricao: "Software Clínico - Abr/26",
    valor: 3200.0,
...
export const payables: Payable[] = [
  {
    ...
    cnpj: "23.195.454/0001-84",
    descricao: "Infraestrutura Cloud - Abr/26",
    valor: 3540.0,
    vencimento: "2026-04-30",
  ...
  {
    id: "PAG-0522",
    fornecedor: "Receita Federal (DARF)",
    cnpj: "00.000.000/0001-00",
    descricao: "IRPJ + CSLL - 1º Trimestre",
    valor: 8340.0,
  ...
  },
  {
    ...
    cnpj: "12.345.678/0001-90",
    descricao: "Salários + Encargos - Abr/26",
    valor: 45200.0,
    vencimento: "2026-04-30",
  ...
  {
    id: "PAG-0524",
    fornecedor: "Aluguel - Edifício Platinum",
    cnpj: "55.666.777/0001-34",
    descricao: "Aluguel Sala Comercial - Mai/26",
    valor: 8500.0,
    vencimento: "2026-05-05",
  ...
  },
  {
    ...
    descricao: "Licenças G Suite - Mai/26",
    valor: 1240.0,
    vencimento: "2026-05-01",
    categoria: "Tecnologia",
    status: "pendente",
    metodo: "cartao" as any,
    aprovacao: "automatico",
  },
  {
    id: "PAG-0526",
    fornecedor: "Fornecedora TI Ativa",
    cnpj: "77.888.999/0001-45",
    descricao: "Manutenção Servidores",
    valor: 6800.0,
  ...
  },
  {
    ...
    fornecedor: "GPS - INSS",
    cnpj: "00.000.000/0001-00",
    descricao: "Contribuição Previdenciária - Mar/26",
    valor: 12400.0,
    vencimento: "2026-04-25",
    categoria: "Impostos",
    status: "pago",
  ...
  {
    id: "PAG-0528",
    fornecedor: "Seguradora Proteção Total",
    cnpj: "88.999.000/0001-56",
  ...
  {
    id: "PAG-0529",
    fornecedor: "Contabilidade Precisão",
    cnpj: "99.000.111/0001-67",
    descricao: "Serviços Contábeis - Abr/26",
    valor: 3800.0,
    vencimento: "2026-04-28",
    categoria: "Serviços",
    status: "pendente",
  ...
  {
    id: "PAG-0530",
    fornecedor: "ISS Municipal",
    cnpj: "00.000.000/0001-00",
    descricao: "ISS Competência Mar/26",
    valor: 2100.0,
    vencimento: "2026-04-22",
    categoria: "Impostos",
    status: "pago",
...
export const users = [
  ...
  },
  {
    ...
    email: "carolina@olympiapag.com.br",
    role: "Financeiro",
    status: "ativo",
  ...
  },
  {
    id: 3,
    nome: "Bruno Santos",
    email: "bruno@olympiapag.com.br",
    role: "Operacional",
    status: "ativo",
    ultimoAcesso: "1d atrás",
    mfa: false,
    avatar: "BS",
  },
  {
    id: 4,
    nome: "Juliana Costa",
    email: "juliana@olympiapag.com.br",
    role: "Visualizador",
    status: "ativo",
    ultimoAcesso: "3d atrás",
    mfa: true,
    avatar: "JC",
  },
  {
    id: 5,
    nome: "Pedro Alves",
    email: "pedro.alves@escritoriocontabil.com.br",
    role: "Contador Externo",
    status: "ativo",
    ultimoAcesso: "5d atrás",
    mfa: false,
    avatar: "PA",
  },
  {
    id: 6,
    nome: "Mariana Silva",
    email: "mariana@olympiapag.com.br",
    role: "Financeiro",
    status: "inativo",
    ultimoAcesso: "15d atrás",
    mfa: false,
    avatar: "MS",
  },
];
...
export const auditLog = [
  {
    ...
    acao: "Aprovou pagamento PAG-0527 (R$ 12.400,00)",
    ip: "177.52.34.12",
    horario: "22/04/26 09:14",
  },
  {
    id: 2,
    usuario: "Carolina Mendes",
    acao: "Criou cobrança REC-1052 para Omega Engenharia",
    ip: "189.32.54.21",
    horario: "22/04/26 08:52",
  },
  {
    id: 3,
    usuario: "Bruno Santos",
    acao: "Enviou lembrete de cobrança para MK Distribuidora",
    ip: "201.18.45.67",
    horario: "22/04/26 08:30",
  },
  {
    id: 4,
    usuario: "Rafael Oliveira",
    acao: "Login realizado — novo dispositivo MacBook Pro",
    ip: "177.52.34.12",
    horario: "22/04/26 08:01",
  },
  {
    id: 5,
    usuario: "Sistema",
    acao: "Conciliação automática — 3 pagamentos confirmados via Open Finance",
    ip: "—",
    horario: "22/04/26 07:00",
  },
];
...
export const recentTransactions = [
  ...
  },
  {
    id: "PAG-0519",
    tipo: "pago",
    cliente: "Aluguel - Edifício Platinum",
    valor: -8500.0,
    metodo: "ted",
    horario: "Ontem",
  },
...
export const integrations = [
  {
    id: 1,
    nome: "Open Finance",
    descricao: "Conecte suas contas bancárias e automatize a conciliação",
    icone: "landmark",
    status: "conectado",
  ...
  },
  {
    id: 2,
    nome: "Pix Cobrança",
    descricao: "Gere QR Codes dinâmicos e Pix Copia e Cola com vencimento",
    icone: "qrCode",
    status: "conectado",
    bancos: [],
  },
  {
    id: 3,
    nome: "Boleto Registrado",
    descricao: "Emissão de boletos registrados com Bolepix",
    icone: "fileText",
    status: "conectado",
    bancos: [],
  },
  {
    ...
    descricao: "Envie cobranças e lembretes via WhatsApp",
    icone: "messageCircle",
    status: "conectado",
    bancos: [],
  },
  {
    id: 5,
    nome: "NF-e / NFS-e",
    descricao: "Emissão automática de notas fiscais integrada ao governo",
    icone: "receipt",
    status: "pendente",
    bancos: [],
  },
  {
    id: 6,
    nome: "Omie ERP",
    descricao: "Sincronize financeiro com o ERP Omie",
    icone: "database",
    status: "disponivel",
    bancos: [],
  },
  {
    id: 7,
    nome: "Conta Azul",
    descricao: "Integração completa com Conta Azul",
    icone: "barChart2",
    status: "disponivel",
    bancos: [],
  },
  {
    id: 8,
    nome: "Bling ERP",
    descricao: "Gestão financeira integrada com Bling",
    icone: "packageOpen",
    status: "disponivel",
    bancos: [],
  },
  {
    id: 9,
    nome: "CNAB 240/400",
    descricao: "Envio e recepção de arquivos de remessa e retorno",
    icone: "folderSync",
    status: "conectado",
    bancos: [],
  },
  {
    id: 10,
    nome: "DDA Automático",
    descricao: "Busca automática de boletos via Débito Direto Autorizado",
    icone: "searchCode",
    status: "disponivel",
    bancos: [],
  },
  {
    id: 11,
    nome: "Totvs / SAP",
    descricao: "Integração enterprise via API REST",
    icone: "building2",
    status: "disponivel",
    bancos: [],
  },
  {
    ...
    descricao: "WooCommerce, Shopify, Mercado Pago, PagSeguro",
    icone: "shoppingCart",
    status: "disponivel",
    bancos: [],
  },
...
export const invoices: Invoice[] = [
  {
    ...
    items: [
      {
        id: "i1",
        descricao: "Consultoria Financeira — 20h",
        qtd: 20,
        unitario: 910.0,
        total: 18200.0,
      },
  ...
  },
  {
    ...
    items: [
      {
        id: "i1",
        descricao: "Laudo Técnico de Estrutura",
        qtd: 1,
        unitario: 14600.0,
        total: 14600.0,
      },
      {
        id: "i2",
        descricao: "Projeto Estrutural Complementar",
        qtd: 1,
        unitario: 10000.0,
        total: 10000.0,
      },
  ...
  },
  {
    ...
    items: [
      {
        id: "i1",
        descricao: "Consultoria Fiscal — Abr/26",
        qtd: 8,
        unitario: 975.0,
        total: 7800.0,
      },
